...
CALL crearProductoServicio(19, 2, 37.25,'Servicio de Calificacion con error'); -- error tipo 2 de producto no debe tener precio
...
CALL realizarDeposito(329704, '28/02/2024', 200.00, 'deposito a 202402 de 202401', 123456789); -- error cliente no existe
CALL realizarDeposito(329797, '28/02/2024', 0.00, 'deposito a 202402 de 202401', 123456789); -- error monto 0
...
CALL realizarDebito(429704, '10/02/2024', 200.85, 'retiro de dinero CuatroEmpresaSC', 202404); -- retiro ya existe
CALL realizarDebito(429704, '10/02/2024', 200.85, 'retiro de dinero CuatroEmpresaSC', 123456789); -- error cliente no existe
CALL realizarDebito(429704, '10/02/2024', 0.00, 'retiro de dinero CuatroEmpresaSC', 202404); -- error monto 0
